...
import { FaGithub, FaLinkedin, FaArrowRight, FaDownload, FaPaintBrush, FaLayerGroup, FaInstagram } from "react-icons/fa";
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-1">
              <a
                ...
                aria-label="GitHub"
                className="w-11 h-11 rounded-full border border-white/15 bg-white/5 backdrop-blur-sm text-white flex items-center justify-center hover:text-neonPink hover:border-neonPink/60 hover:shadow-[0_0_20px_rgba(255,16,240,0.25)] transition-all duration-300"
              >
              ...
              <div className="absolute bottom-[15%] -right-[5%] md:-right-[20px] z-20 animate-bounce" style={{ animationDuration: '4s' }}>
                <div className="flex items-center gap-3 bg-[#0f111a]/80 backdrop-blur-xl p-4 rounded-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] pr-6 hover:bg-[#0f111a] transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold text-lg">10+ Done</p>
                  </div>
                </div>
              </div>
